...
Sou desenvolvedor de software com experiência em **desenvolvimento full-stack, dados e soluções com Inteligência Artificial**, atuando na construção de aplicações, APIs, dashboards e produtos orientados à geração de valor.

Minha atuação combina **backend**, **frontend** e **análise de dados**, com experiência em desenvolvimento de sistemas, estruturação de informações, criação de indicadores, integração entre serviços e apoio à tomada de decisão por meio de tecnologia.

Também venho aprofundando projetos com **LLMs, RAG, agentes de IA, visão computacional e automação**, buscando sempre unir engenharia, inteligência analítica e impacto prático em produtos e processos.
...
![Neural Networks](https://img.shields.io/badge/Neural%20Networks-1F6FEB?style=for-the-badge)
...
- Backend e APIs
- Dados, indicadores e dashboards
